...
# Configuración aséptica estricta para evitar inyecciones de estilos flotantes
...
# Copiamos tu archivo index10.html exactamente como tu ancla de control visual nativa
