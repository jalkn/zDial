...
# Dejamos que compile en dist temporal para no violar la regla de seguridad de Astro
...
# =========================================================================
# 3. Static Assets Provisioning (NATIVE INDEX10 ANCHOR)
# =========================================================================
echo -e "\n${MAGENTA}[3/5] Provisioning pristine index10.html asset as core target...${NC}"
...
# =========================================================================
# 4. Clean Frontend Architecture (MUTED FOR STATIC ISOLATION)
# =========================================================================
...
# =========================================================================
# 5. Environment Validation, Build & Root Extraction
# =========================================================================
...
# PIPELINE DE EXTRACCIÓN: Movemos el index compiled de forma segura a la raíz
