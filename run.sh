            ...
            <div class="relative w-full max-w-[340px] sm:max-w-[400px] md:max-w-[450px] aspect-square flex flex-col items-center justify-center gap-6">
                ...
                <div id="artepanel-pack-container" class="relative w-[65vw] h-[65vw] sm:w-[50vw] sm:h-[50vw] md:w-[38vh] md:h-[38vh] max-w-[270px] max-h-[270px] min-w-[180px] min-h-[180px] aspect-square shrink-0 drop-shadow-[0_25px_55px_rgba(0,0,0,0.85)] cursor-pointer">
                    <div id="artepanel-mask-wrapper" class="w-full h-full relative overflow-hidden rounded-full transition-all duration-500" style="background-image: linear-gradient(135deg, var(--gradient-start) 0%, var(--gradient-mid) 50%, var(--gradient-end) 100%);">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center p-0 z-20 leading-none">
                            <svg id="laser-vector-target" viewBox="0 0 400 400" class="w-full h-full block fill-none stroke-current text-jako-text transition-all duration-500">
                                
                                <g id="wave-quantum-container" style="transform: rotate(-90deg); -webkit-transform: rotate(-90deg); transform-origin: 200px 200px; -webkit-transform-origin: 200px 200px;"></g>

                                <g id="sandwatch-group" style="transform-origin: 200px 200px; -webkit-transform-origin: 200px 200px; will-change: opacity;" class="opacity-0 transition-all duration-500 style-gpu">
        ...
        function renderBiokineticWaves() {
            ...
            biokineticWaveHistory.forEach((dial, tIndex) => {
                ...
                layers.forEach(layer => {
                    ...
                    // Se inyecta la transformación por CSS directo mitigando el bug de Safari
                    htmlContent += `
                        <circle 
                            ...
                            cy="200" 
                            r="${layer.r}" 
                            style="transform: rotate(${angle}deg); -webkit-transform: rotate(${angle}deg); transform-origin: 200px 200px; -webkit-transform-origin: 200px 200px;"
